...
`r paste("Mean Steps per Day =", mean(data.cast.date$steps, na.rm=TRUE))` and

`r paste("Median Steps per Day =", median(data.cast.date$steps, na.rm=TRUE))` 
...
`r paste("Mean Steps per Day =", mean(data.no.na.cast$steps, na.rm=TRUE))` and

`r paste("Median Steps per Day =", median(data.no.na.cast$steps, na.rm=TRUE))`
